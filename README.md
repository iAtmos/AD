...
- OR | дать коментарии о корректности работы
- AND | дать коментарии о корректности работы
- NAND | дать коментарии о корректности работы
- XOR | дать коментарии о корректности работы
